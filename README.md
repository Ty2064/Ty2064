...
💻 Interested in Software Development, Backend, Networking, and Artificial Intelligence
...
Technologies: Python, AI, CLI, Git/GitHub, Tauri, HTML, CSS

💧 HydroCálculo

A project focused on estimating water consumption associated with the use of Artificial Intelligence systems, relating variables such as usage, inference time, and water consumption.

Technologies: HTML, CSS, JavaScript


<!--
**Ty2064/Ty2064** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
